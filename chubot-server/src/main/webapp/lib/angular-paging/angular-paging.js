...
angular.module('tm.pagination', [])
    .directive('tmPagination',[function(){
        return {
            restrict: 'EA',
            templateUrl: '/lib/angular-paging/paging.html',
            replace: true,
            scope: {
                conf: '='
            },
            link: function(scope, element, attrs){
                ...
                function getPagination(){
                    // just a flag to indicate force refresh need.
                    scope.conf.forceRefresh = false;
                    // conf.currentPage
                ...
                scope.$watch(function(){
                    var newValue = scope.conf.currentPage + ' ' + scope.conf.totalItems + ' ' + scope.conf.forceRefresh;
